...
export default function LessonsPage() {
  ...
  const [sophisticationLevel, setSophisticationLevel] = useState<SophisticationLevel | 'all'>('all');
    ...
    try {
      const response = await fetch('/api/lessons', {
        ...
        body: JSON.stringify({
          ...
          language,
          sophisticationLevel: sophisticationLevel !== 'all' ? sophisticationLevel : undefined,
        }),
      });
      ...
      <div className="mb-6 bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <select
              value={generation}
              onChange={(e) => setGeneration(e.target.value as Generation | 'all')}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setSophisticationLevel(e.target.value as SophisticationLevel | 'all')}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            >
              <option value="all">All</option>
